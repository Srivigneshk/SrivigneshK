...
I'm **Srivignesh**, a Computer Science Engineering student passionate about building reliable software systems, AI-powered applications, and scalable full-stack solutions.
...
`Java` • `Python` • `C` • `C++` • `JavaScript` • `HTML` • `CSS` • `Git` • `GitHub`
...
<a href="https://leetcode.com/u/srivignesh_k/">
...
<img src="https://img.shields.io/badge/GitHub-Explore%20Repositories-181717?style=for-the-badge&logo=github"/>
